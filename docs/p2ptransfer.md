...
- When a user receives message:
  - If `message.encrypted` is false, send the message to everyone connected to me, exerpt for the one who just transferred the message to me. Display the message for myself too.
